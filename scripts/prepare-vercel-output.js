...
const entries = ['index.html', 'robots.txt', 'sitemap.xml', 'CNAME', 'assets', 'products', 'categories', 'about', 'contact', 'faq', 'shipping', 'returns', 'payment', 'geargao-logo.svg', 'geargao-header-logo.svg', 'geargao-banner.svg', 'logo.svg'];
async function main() {
